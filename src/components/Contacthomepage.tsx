...
export default function Contacthomepage() {
  ...
  const offices = [
    ...
    {
      city: "Dallas",
      address: "1201 Elm Street, Executive Tower",
      timezone: "CST (UTC-6)",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Connect with our strategic consulting experts to discuss your business transformation goals. 
            Let's build a roadmap to sustainable growth and competitive advantage.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your current business challenges, strategic goals, timeline, and expected outcomes..."
                  />
                </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-accent/10 rounded-lg border border-accent/20">
                  <p className="text-sm text-accent font-medium flex items-center gap-2">
                    ...
                    Executive support available 24/7 for active engagements
                  </p>
                </div>
              </CardContent>
            </Card>
